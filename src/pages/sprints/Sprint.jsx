      ...
      <SprintStyled>
        ...
        <article>
          <div className="headerWrap">
            ...
            {767 && (
              <>
                <Button icon={buttonIcons.add} classBtn="add" onHandleClick={() => setOpenModalSprints(true)} />
                <CreateSprint closeModal={openModalSprints} setOpenModal={setOpenModalSprints} />
              </>
            )}
          </div>
